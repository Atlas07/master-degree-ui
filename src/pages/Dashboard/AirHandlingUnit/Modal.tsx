...
import {
  AirHandlingUnitType,
  createAirHandlingUnit,
  CreateAirHandlingUnitType,
...
type Props = {
  ...
  initialValues: AirHandlingUnitType | null;
};
...
const Modal: FC<Props> = ({ isOpen, onClose, onSubmit, initialValues }) => {
  ...
  const handleSubmit = (e: FormEvent<HTMLButtonElement>) => {
    ...
    const request = initialValues
      ? updateAirHandlingUnit({ id: initialValues.id, ...values })
      : createAirHandlingUnit(values);
