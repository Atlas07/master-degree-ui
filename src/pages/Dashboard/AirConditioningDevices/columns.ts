...
const COLUMNS = [
  ...
  {
    Header: 'Air condition device',
    accessor: 'airConditioningDevice',
  },
  {
    Header: 'Cooling capacity',
    accessor: 'coolingCapacity',
  },
  {
    Header: 'Room area square (m)',
    accessor: 'roomAreaSquareM',
  },
  {
    Header: 'Created when',
